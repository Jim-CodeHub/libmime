...
class param{
	public:
		...
		param(const char *name, string::size_type _nSize, const char *value, string::size_type _vSize	);
		...
		void set(const char *name, string::size_type _nSize, const char *value, string::size_type _vSize);
		...
		static const string get_name (const string &param												);
		static const string get_name (const char *param, string::size_type _size					    );
		static const string get_name (const char *param													);
